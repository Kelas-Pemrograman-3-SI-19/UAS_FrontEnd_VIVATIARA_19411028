...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'datatrevel', name: 'dataTrevel', component: () => import('src/pages/admin/DataTrevel.vue') },
      { path: 'edittrevel/:id', name: 'editTrevel', component: () => import('pages/admin/FormEdit.vue') }
    ]
  },
  {
    path: '/user',
